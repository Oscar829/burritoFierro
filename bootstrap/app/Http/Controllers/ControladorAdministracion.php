...
/*Método para retornar a la vista todos los ingredientes registrados en la base de datos, para que sean mostrados en la tabla de ingredientes*/
	public function retornarIngredientes(){
		...
		return view('inicioAdministracion', compact('listadoIngredientes', 'listadoReportes','listadoNotificaciones', 'pedidoComidaM1', 'pedidoBebidaM1', 'pedidoComidaM2', 'pedidoBebidaM2', 'pedidoComidaM3', 'pedidoBebidaM3', 'pedidoComidaM4', 'pedidoBebidaM4', 'pedidoComidaM5', 'pedidoBebidaM5', 'pedidoComidaM6', 'pedidoBebidaM6', 'pedidoComidaM7', 'pedidoBebidaM7'));
